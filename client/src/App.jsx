...
function App() {
  ...
  const renderPage = () => {
    ...
    switch (resolvedCurrentPage) {
      ...
      case 'manager': return <Dashboard db={erp.db} user={user} />;
      case 'billing': return canManageAdminPages ? <Dashboard db={erp.db} user={user} /> : <Billing erp={erp} user={user} />;
      case 'products': return <Products db={erp.db} erp={erp} user={user} />;
      case 'stock': return <Stock db={erp.db} erp={erp} user={user} />;
      case 'pricing': return canManageAdminPages ? <Pricing db={erp.db} erp={erp} user={user} /> : <Dashboard db={erp.db} user={user} />;
      case 'priceboard': return <PriceBoard db={erp.db} />;
      case 'sales': return <Sales db={erp.db} user={user} />;
      case 'customers': return canViewCustomers ? <Customers db={erp.db} /> : <Dashboard db={erp.db} user={user} />;
      case 'reports': return <Reports db={erp.db} user={user} />;
      case 'loginlog': return canManageAdminPages ? <LoginActivity db={erp.db} erp={erp} user={user} /> : <Dashboard db={erp.db} user={user} />;
      case 'settings': return canViewSettings ? <Settings db={erp.db} erp={erp} user={user} /> : <Dashboard db={erp.db} user={user} />;
